 ...
 * * * -------------------------------------------------------
 * 【 ⚙️ 核心架构说明 】
 * 1. 全局接管 GUI 设置：覆盖客户端基础设置 (端口/模式/TUN)，实现底层参数统一
 ...
 * 4. 五大洲节点自动筛选分组：Unicode 国旗解码；内置 240+ 国家与城市字典
 *
 * * 【 ⚠️ 必读设置 】
 * 1. 关闭浏览器安全 DNS：Chrome 设置 -> 隐私与安全 -> 关闭 "使用安全 DNS"。防止浏览器绕过客户端自己去解析 DNS，导致分流失败
 * 2. Windows 用户：关闭 "智能多宿主名称解析" (组策略或注册表修改)，防止 DNS 请求泄露
 * 3. IPv6 相关设置（两者选其一）
