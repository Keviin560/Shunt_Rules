...
def generate_readme(stats):
    ...
    md = [
        ...
        f"",
        f"* **AI_Rules**：聚合了主流对话式 AI（ChatGPT, Claude, Gemini 等）和 AI 开发者平台",
        f"  <br>`已包含：OpenAI (ChatGPT/Sora)、Anthropic (Claude)、Google (Gemini/谷歌 AI 家族)、xAI (Grok)、Meta AI、Mistral AI、Cursor、Microsoft/GitHub Copilot、Codeium & Windsurf、Devin、Trae & MarsCode、CodeRabbit、Perplexity、Poe、OpenRouter、ElevenLabs、ComfyUI、OpenArt & Clipdrop、Hugging Face、Groq、Cerebras、Dify、Cloudflare AI、LiveKit、Cici/Coze、Manus等`",
        f"* **Game_Proxy**：纯国外游戏平台分流，涵盖了主流的 PC 游戏、主机平台、手游大厂和垂直的游戏社区",
        f"  <br>`已涵盖：Steam (Valve)、Epic Games、GOG (CD Projekt)、EA (Electronic Arts/Origin)、Ubisoft (Uplay/Ubisoft Connect)、Rockstar Games (Social Club)、Nintendo (任天堂)、Xbox (Microsoft Gaming)、PlayStation (Sony)、Riot Games (拳头游戏)、Blizzard (战网/暴雪)、PUBG (绝地求生)、osu!、Escape from Tarkov (逃离塔科夫)、HoYoverse (米哈游国际服)、Supercell、Yostar (悠星)、Cygames、Garena、Minecraft (我的世界)、Roblox (罗布乐思)、itch.io等`",
        f"",
        f"## 📍 Mihomo 配置",
